...
const material = new THREE.MeshStandardMaterial({ color: 0x322d53 });
...
// Avatar
const avatarTexture = new THREE.TextureLoader().load('images/mymac.jpg');
const avatar = new THREE.Mesh(new THREE.BoxGeometry(3, 3, 3), new THREE.MeshBasicMaterial({ map: avatarTexture }));
scene.add(avatar);

// Globe
const globeTexture = new THREE.TextureLoader().load('images/worldmap.jpg');
